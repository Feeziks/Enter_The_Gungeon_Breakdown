...
public class Slot
{
  ...
  //The cached neighbors for this slot
  public Dictionary<string, Vector2Int> neighbors;
  ...
  //Class constructor
  public Slot(Vector2Int p, List<Piece> pieceSet, Transform par)
  {
    position = p;
    active = false;
    ...
    parent = par;
    neighbors = new Dictionary<string, Vector2Int>();
  }
